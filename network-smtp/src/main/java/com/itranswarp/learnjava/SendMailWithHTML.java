...
public class SendMailWithHTML {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String username = "liyaandnina@163.com";
        final String password = "CBRJUMGCVKFXYHES";
        final String from = "liyaandnina@163.com";
        final String to = "kekai.sun@wibu.com.cn";
