...
public abstract class AbstractDao<T> extends JdbcDaoSupport {
    ...
    public List<T> getAll(int pageIndex) {
        ...
        return getJdbcTemplate().query("SELECT * FROM " + table + " LIMIT ? OFFSET ?", rowMapper, new Object[]{limit, offset});
    }

//    public List<T> getAll(int pageIndex) {
//        return getJdbcTemplate().query("SELECT * FROM " + table, getRowMapper());
//    }
